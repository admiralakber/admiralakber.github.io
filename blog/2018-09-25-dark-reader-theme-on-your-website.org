...
#+END_SRC
  ...
  the toggle icon. You can find my code current to this post [[https://github.com/admiralakber/admiralakber.github.io/blob/master/js/aa-goodies.js][in this
  file/commit]].
  ...
  can find my version current of this post in [[https://github.com/admiralakber/admiralakber.github.io/blob/master/_includes/header.html][this file/commit]].
